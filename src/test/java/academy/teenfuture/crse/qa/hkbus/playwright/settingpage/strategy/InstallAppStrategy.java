...
/**
 * Strategy for handling the "Install the App" pop-up. This class extends
...
public class InstallAppStrategy extends PopUpStrategy {
	/**
	 * Handles the pop-up interaction for the "Install the App" dialog. It waits for
	 * the dialog to appear, checks the header text, and then closes the dialog.
	 *
	...
	public boolean handlePopUp(Page page) {
		...
		String expectedHeaderText = "Installation Steps";
