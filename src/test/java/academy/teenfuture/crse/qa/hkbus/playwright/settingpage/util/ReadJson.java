package academy.teenfuture.crse.qa.hkbus.playwright.settingpage.util;
...
public class ReadJson {
	...
	static String filePath = System.getProperty("user.dir")
			+ "/src/test/java/academy/teenfuture/crse/qa/hkbus/playwright/settingpage/navigate.json";
