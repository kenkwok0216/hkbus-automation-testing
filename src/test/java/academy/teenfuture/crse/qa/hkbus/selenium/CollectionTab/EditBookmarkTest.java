    ...
    public void editBookmark() throws InterruptedException {
        ...
        WebElement numberPanel1 = wait
                .until(ExpectedConditions.elementToBeClickable(
                        By.xpath("//button[normalize-space(text())='5']")));
        WebElement numberPanel2 = wait
                .until(ExpectedConditions.elementToBeClickable(
                        By.xpath("//button[normalize-space(text())='9']")));
        WebElement numberPanel3 = wait
                .until(ExpectedConditions.elementToBeClickable(
                        By.xpath("//button[normalize-space(text())='X']")));
        numberPanel1.click();
        numberPanel2.click();
        numberPanel3.click();
        Thread.sleep(1000);
        ...
        WebElement addBusStopBtn = wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath(
                        "//*[@id=\"stop-0\"]/div[2]/div/div/div/div/div[2]/div[2]/button[2]")));
        addBusStopBtn.click();
        Thread.sleep(1000);
        ...
        WebElement starredCollection = wait.until(ExpectedConditions
                .elementToBeClickable(By.xpath(
                        "//*[@id=\"root\"]/div/div[2]/div/div[1]/div[3]/div/button[2]")));
