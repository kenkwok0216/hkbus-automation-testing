...
public class FontSizeAndKeyBoardTest extends BaseTest {
	...
	public void fontSizeInitialTest() throws InterruptedException, IOException {
		...
		WebElement settingsButton = driver
				.findElement(By.xpath("//a[contains(@class,'MuiButtonBase-root MuiIconButton-root')]"));
		...
		WebElement initialValueLabel = driver
				.findElement(By.xpath("(//span[contains(@class,'MuiSlider-root MuiSlider-colorPrimary')])[2]"));
	...
	public void fontSizeChangeTest() throws InterruptedException, IOException {
		...
		// Navigate to settings page
		WebElement settingsButton = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//a[contains(@class,'MuiButtonBase-root MuiIconButton-root')]")));
		settingsButton.click();

		// Navigate to personal settings
		WebElement personalSettings = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='root']/div/div[2]/div/ul/div[6]")));
		personalSettings.click();

		// Locate the slider value label
		WebElement valueLabel = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("(//span[contains(@class,'MuiSlider-root MuiSlider-colorPrimary')])[2]")));
		valueLabel.click();
		...
		WebElement font = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//html/body/div[3]/div[3]/div/ul/li/div[2]/p[1]")));
		...
		personalSettings = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='root']/div/div[2]/div/ul/div[6]")));
		personalSettings.click();

		// Locate the slider value label again
		WebElement valueLabel3 = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("(//span[contains(@class,'MuiSlider-root MuiSlider-colorPrimary')])[2]")));
		valueLabel3.click();
		...
		font = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//html/body/div[3]/div[3]/div/ul/li/div[2]/p[1]")));
	...
	public void keyboardLayoutCheck() throws InterruptedException, IOException {
		...
		WebElement settingKeyboardLayoutButton = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//li[contains(@class,'MuiListItem-root MuiListItem-gutters')]/following-sibling::div[1]")));
		...
		WebElement backButton = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//button[contains(@class,'MuiButtonBase-root MuiIconButton-root')])[2]")));
		backButton.click();
		Thread.sleep(2000);

		// Click and display Search page
		WebElement searchButton = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//a[contains(@class,'MuiButtonBase-root MuiBottomNavigationAction-root')])[3]")));
		searchButton.click();
		Thread.sleep(2000);

		// Check if buttonboard display according to the order
		WebElement buttonboard = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div[2]/div[2]/div[1]")));
		...
		// Navigate to settings page again
		WebElement settingsLink = wait
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='root']/div/div[1]/div[3]/a")));
		settingsLink.click();
		Thread.sleep(2000);
		...
		WebElement settingKeyboardLayoutButton2 = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//li[contains(@class,'MuiListItem-root MuiListItem-gutters')]/following-sibling::div[1]")));
		...
		WebElement buttonboard2 = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div[2]/div[2]/div[1]")));
	...
	public void historyOnOff() throws InterruptedException, IOException {
		...
		WebElement history = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//html/body/div[3]/div[3]/div/ul/div[11]")));
		...
		WebElement header = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div[2]/div[1]/div[1]/div/div/div")));
		...
		if (recentExists) {
			...
			super.generateExtentTest("Recent button enable", false, "Recent should exist in this case",
		...
		header = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@id='root']/div/div[2]/div[1]/div[1]/div/div/div")));
		...
		if (recentExistsAfterToggle) {
			System.out.println("Recent exists");
			super.generateExtentTest("Recent button disable", false, "Recent should not exist in this case",
					super.captureScreenshot());
		} else {
			System.out.println("Recent not exists");
